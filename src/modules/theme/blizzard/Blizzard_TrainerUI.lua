...
C.Themes['Blizzard_TrainerUI'] = function()
    ...
    _G.ClassTrainerFrameSkillStepButton:SetNormalTexture(C.Assets.Textures.Blank)
    _G.ClassTrainerFrameSkillStepButton:SetHighlightTexture(C.Assets.Textures.Blank)
    _G.ClassTrainerFrameSkillStepButton.disabledBG:SetTexture(C.Assets.Textures.Blank)
        ...
        hooksecurefunc(_G.ClassTrainerFrame.ScrollBox, 'Update', function(self)
            for i = 1, self.ScrollTarget:GetNumChildren() do
                ...
                if not button.styled then
                    ...
                    button.disabledBG:SetTexture(C.Assets.Textures.Blank)
