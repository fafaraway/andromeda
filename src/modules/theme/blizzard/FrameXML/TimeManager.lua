...
tinsert(C.BlizzThemes, function()
    ...
    F.ReskinCheckButton(_G.TimeManagerAlarmEnabledButton)
    F.ReskinCheckButton(_G.TimeManagerMilitaryTimeCheck)
    F.ReskinCheckButton(_G.TimeManagerLocalTimeCheck)
