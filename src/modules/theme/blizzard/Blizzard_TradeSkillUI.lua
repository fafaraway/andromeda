...
C.Themes['Blizzard_TradeSkillUI'] = function()
    ...
    F.CreateBDFrame(rankFrame, 0.25)
    ...
    hooksecurefunc(recipe, 'OnLearnedTabClicked', function()
        recipe.Tabs[1].bg:SetBackdropColor(r, g, b, 0.2)
        recipe.Tabs[2].bg:SetBackdropColor(0, 0, 0, 0.2)
    end)
    hooksecurefunc(recipe, 'OnUnlearnedTabClicked', function()
        recipe.Tabs[1].bg:SetBackdropColor(0, 0, 0, 0.2)
        recipe.Tabs[2].bg:SetBackdropColor(r, g, b, 0.2)
    end)
    ...
    local bg = F.CreateBDFrame(scrollList, 0.25)
    ...
    reagentList:HookScript('OnShow', function()
        for i = 1, #scrollList.ScrollFrame.buttons do
            ...
            if not button.bg then
                ...
                local bg = F.CreateBDFrame(button.NameFrame, 0.2)
