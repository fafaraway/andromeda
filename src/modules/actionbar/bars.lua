...
function BAR:CreateBar1()
    ...
    local frame = CreateFrame('Frame', C.ADDON_TITLE .. 'ActionBar1', _G.UIParent, 'SecureHandlerStateTemplate')
...
function BAR:UpdateFrameClickThru()
    ...
    local function updateClickThru()
        _G[C.ADDON_TITLE .. 'ActionBar4']:EnableMouse(showBar4)
        _G[C.ADDON_TITLE .. 'ActionBar5']:EnableMouse((not showBar4 and showBar4) or (showBar4 and showBar5))
    end
...
function BAR:CreateBar4()
    ...
    local frame = CreateFrame('Frame', C.ADDON_TITLE .. 'ActionBar4', _G.UIParent, 'SecureHandlerStateTemplate')
...
function BAR:CreateStanceBar()
    ...
    F:RegisterEvent('UPDATE_SHAPESHIFT_FORMS', BAR.StanceBarOnEvent)
    F:RegisterEvent('UPDATE_SHAPESHIFT_USABLE', BAR.StanceBarOnEvent)
    F:RegisterEvent('UPDATE_SHAPESHIFT_COOLDOWN', BAR.StanceBarOnEvent)
...
function BAR:UpdateExtraBar()
    local frame = _G[C.ADDON_TITLE .. 'ActionBarExtra']
    if not frame then
        return
    end
