...
local gameIcons = {
    [_G.BNET_CLIENT_WOW] = C.ASSET_PATH .. 'textures\\client\\WoWSL',
    [_G.BNET_CLIENT_WOW .. 'C'] = C.ASSET_PATH .. 'textures\\client\\WoW',
    [_G.BNET_CLIENT_WOW .. 'C_TBC'] = C.ASSET_PATH .. 'textures\\client\\WoWC',
    [_G.BNET_CLIENT_D2] = C.ASSET_PATH .. 'textures\\client\\D2',
    [_G.BNET_CLIENT_D3] = C.ASSET_PATH .. 'textures\\client\\D3',
    [_G.BNET_CLIENT_WTCG] = C.ASSET_PATH .. 'textures\\client\\HS',
    [_G.BNET_CLIENT_SC] = C.ASSET_PATH .. 'textures\\client\\SC',
    [_G.BNET_CLIENT_SC2] = C.ASSET_PATH .. 'textures\\client\\SC2',
    [_G.BNET_CLIENT_APP] = C.ASSET_PATH .. 'textures\\client\\App',
    ['BSAp'] = C.ASSET_PATH .. 'textures\\client\\Mobile',
    [_G.BNET_CLIENT_HEROES] = C.ASSET_PATH .. 'textures\\client\\HotS',
    [_G.BNET_CLIENT_OVERWATCH] = C.ASSET_PATH .. 'textures\\client\\OW',
    [_G.BNET_CLIENT_COD] = C.ASSET_PATH .. 'textures\\client\\COD',
    [_G.BNET_CLIENT_COD_BOCW] = C.ASSET_PATH .. 'textures\\client\\COD_CW',
    [_G.BNET_CLIENT_COD_MW] = C.ASSET_PATH .. 'textures\\client\\COD_MW',
    [_G.BNET_CLIENT_COD_MW2] = C.ASSET_PATH .. 'textures\\client\\COD_MW2',
    [_G.BNET_CLIENT_WC3] = C.ASSET_PATH .. 'textures\\client\\WC3',
    [_G.BNET_CLIENT_CLNT] = _G.BNet_GetClientTexture(_G.BNET_CLIENT_CLNT),
    [_G.BNET_CLIENT_CRASH4] = C.ASSET_PATH .. 'textures\\client\\CRASH4',
    [_G.BNET_CLIENT_ARCADE] = _G.BNet_GetClientTexture(_G.BNET_CLIENT_ARCADE),
    [_G.BNET_CLIENT_COD_VANGUARD] = C.ASSET_PATH .. 'textures\\client\\COD_VG',
    [_G.BNET_CLIENT_DI] = C.ASSET_PATH .. 'textures\\client\\DI',
    [_G.BNET_CLIENT_ARCLIGHT] = C.ASSET_PATH .. 'textures\\client\\ARCLIGHT',
}
