...
L.ANNOUNCEMENT = {
    ...
    QUEST_ANNOUNCE_TIP = 'Пусть ваши тиммейты знают о ходе выполнения заданий.',
...
L.QUEST = {
    AUTOMATION = 'Автоматизация квестов',
...
do
    ...
    L['CHAT_WHISPER_TELL'] = 'Сказал'
    L['CHAT_WHISPER_FROM'] = 'Для'
...
do
    ...
    L['COMBAT_MOVER_IN'] = 'FCT скоро'
    L['COMBAT_MOVER_OUT'] = 'FCT уходит'
...
do
    ...
    L['INVENTORY_QUICK_DELETE_ENABLED'] =
        '|nВы можете удалить элемент сумки, удерживая CTRL+ALT. Предмет может быть фамилькой или его качество ниже редкого (синий).'
    L['INVENTORY_QUICK_DELETE'] = 'Быстрое удаление'
    L['INVENTORY_PICK_FAVOURITE_ENABLED'] =
        '|nТеперь можно пометить звездочкой.|nЕсли включен \'Фильтр сумок\', то выбранный вами элемент будет добавлен в слоты фильтра предпочтений.|nНельзя выбрать для мусора.'
    ...
    L['INVENTORY_SELL_JUNK_EARN'] = 'Автопродажа барахла на (%s)'
    ...
    L['INVENTORY_SPLIT_MODE_ENABLED'] =
        '|nНажмите, чтобы разделить предметы в ваших сумках|nВы можете изменить split count для каждого клика через поле редактирования.'
...
L.GUI = {
    ...
    ['MISC'] = {
        ...
        ['AUTO_SCREENSHOT'] = 'Включить авто-скриншоты',
        ['AUTO_SCREENSHOT_ACHIEVEMENT'] = 'Новое достижение заработано',
        ['AUTO_SCREENSHOT_CHALLENGE'] = 'Мифик+ завершено',
        ['ITEM_LEVEL'] = 'iLvL',
        ['ITEM_LEVEL_TIP'] = 'Показать iLvL в рамке персонажа.',
        ['GEM_ENCHANT'] = 'Чарки и камни',
        ['GEM_ENCHANT_TIP'] = 'Показывать Чарки и камни в рамке персонажа.',
    ...
    ['APPEARANCE'] = {
        ['NAME'] = 'Стили',
        ['CURSOR_TRAIL'] = 'Хвост у курсора',
        ['RESKIN_BLIZZ'] = 'Рестайл Blizzard фреймов',
        ['VIGNETTING'] = 'Виньетка',
        ['BACKDROP_ALPHA'] = 'Фон альфа',
        ['VIGNETTING_ALPHA'] = 'Виньетка альфа',
        ['SHADOW_BORDER'] = 'Граница тени',
        ['UI_SCALE'] = 'Маштаб UI',
    ...
    ['CHAT'] = {
        ...
        ['VOICE_BUTTON'] = 'Голосовая кнопка',
        ['TAB_CYCLE'] = 'Цикл вкладки',
        ['TAB_CYCLE_TIP'] = 'Нажмите Tab, когда поле ввода, чтобы быстро переключить канал.',
        ['SMART_BUBBLE'] = 'Умные баблы',
        ['SMART_BUBBLE_TIP'] = 'Введите копию, чтобы включить всплывающее окно чата, оставьте копию, чтобы закрыть всплывающее окно чата.',
        ['WHISPER_STICKY'] = 'Липкий шопот',
        ['WHISPER_SOUND'] = 'Звук лички',
        ['ITEM_LINKS'] = 'Расширить ссылку на элемент',
    ...
    ['AURA'] = {
        ...
        ['REMINDER'] = 'Напоминалка для баффов',
        ['REMINDER_TIP'] = 'Напоминать вам о недостатке баффа собственного класса.|nПоддержка: Выносливость, Яды, Интелект, Боевой крик.',
    },
    ...
    ['ACTIONBAR'] = {
        ...
        ['COOLDOWN_COUNT'] = 'Количество перезарядок',
        ['DECIMAL_CD'] = 'Дин. для перезарядок в 3с',
        ['OVERRIDE_WA'] = 'Скрыть КД на WeakAuras',
        ['CD_FLASH'] = 'Вспышка перезарядки',
    ...
    ['COMBAT'] = {
        ...
        ['EASY_FOCUS'] = 'Изи фокус',
        ['EASY_FOCUS_TIP'] = 'Shift+щелчок левой кнопкой мыши по фрейму юнита быстро устанавливается в фокус.',
        ['EASY_FOCUS_ON_UNITFRAME'] = 'Изи фокус по юнитфреймам',
        ['EASY_FOCUS_ON_UNITFRAME_TIP'] = 'Изи фокус по юнитфреймам если работают.',
        ...
        ['FCT_IN'] = 'Показывать входящий',
        ['FCT_OUT'] = 'Показывать исходящий',
        ['FCT_PET'] = 'Показывать петомца',
        ['FCT_PERIODIC'] = 'Показывать переодический',
        ['FCT_MERGE'] = 'Поглащенный',
    },
    ...
    ['MAP'] = {
        ...
        ['REMOVE_FOG'] = 'Убрать туман войны с карты',
        ...
        ['MINIMAP_SCALE'] = 'Размер миникарты',
    },
    ...
    ['TOOLTIP'] = {
        ...
        ['BORDER_COLOR'] = 'Граница окрашена по качеству',
        ...
        ['SPEC_ILVL_TIP'] = 'Зажать ALT для показа Спека и iLvLа.',
    ...
    ['UNITFRAME'] = {
        ...
        ['CONDITION_COMBAT'] = 'Бой',
        ['CONDITION_TARGET'] = 'Цель',
        ...
        ['FADE_OUT_ALPHA'] = 'Затухание альфа',
        ['FADE_IN_ALPHA'] = 'Появление альфа',
        ['FADE_OUT_DURATION'] = 'fade out duration',
        ['FADE_IN_DURATION'] = 'fade in duration',
        ['RANGE_CHECK'] = 'Проверка дальности',
        ['PORTRAIT'] = 'Портреты',
        ['HEAL_PREDICTION'] = 'Предикт исцеления',
        ['GCD_SPARK'] = 'Инжикатор GCD',
    ...
    ['GROUPFRAME'] = {
        ...
        ['AURAS_CLICK_THROUGH'] = 'Скрыть подсказки от аур',
        ['PARTY_SPELL_WATCHER'] = 'Показать групповые закл.',
        ['PARTY_SPELL_SYNC'] = 'Синхранизировать групповые заклинания',
        ...
        ['GROUP_CLICK_CAST'] = 'Клик каст на групфреймах',
    ...
    ['NAMEPLATE'] = {
        ...
        EXPLOSIVE_INDICATOR = 'Индикатор "Взрывной"',
        ...
        MAJOR_SPELLS_GLOW = 'Свечение основных заклинаний',
        ...
        FRIENDLY_CLASS_COLOR = 'Окрашивание дружелюбных игроков по классам',
        HOSTILE_CLASS_COLOR = 'Окрашивание враждебных игроков по классам',
        TANK_MODE = 'Мод Танка',
        ...
        COLORED_FOCUS = 'Dyeing focus unit', -- Need translate
        COLORED_FOCUS_TIP = '|nIf enabled, dyeing your focus\'s nameplate, its priority is higher than custom color and threat color.|nYou can customize the color below.', -- Need translate
        FOCUS_COLOR = 'Focus color', -- Need translate
