...
--@localization(locale="zhCN", format="lua_additive_table", same-key-is-true=true)@
    ...
    --[[Translation missing --]]
    L["|nEnter the character name that you intend to delete its profile, the input format is 'UnitName-RealmName'. You only need to enter name if unit is in the same realm with you.|n|nThis will delete unit gold info as well.|n|nPress key ESC to clear editbox, press key Enter to confirm."] = "|nEnter the character name that you intend to delete its profile, the input format is 'UnitName-RealmName'. You only need to enter name if unit is in the same realm with you.|n|nThis will delete unit gold info as well.|n|nPress key ESC to clear editbox, press key Enter to confirm."
    ...
    --[[Translation missing --]]
    L["|nFill in SpellID, must be a number.|nYou can get ID from spell's GameTooltip.|nSpell name is not supported."] = "|nFill in SpellID, must be a number.|nYou can get ID from spell's GameTooltip.|nSpell name is not supported."
    ...
    --[[Translation missing --]]
    L["You can manage your addon profile, please backup your settings before start. The default settings is based on your character, won't share within the same account. You can switch to the shared profile to share between your characters, and get rid of data transfer.|nData export and import only support the current profile."] = "You can manage your addon profile, please backup your settings before start. The default settings is based on your character, won't share within the same account. You can switch to the shared profile to share between your characters, and get rid of data transfer.|nData export and import only support the current profile."
    --[[Translation missing --]]
    L["You need to uncheck Profanity Filter in GUI and restart your game client to get access into CN battleNet support"] = "You need to uncheck Profanity Filter in GUI and restart your game client to get access into CN battleNet support"
