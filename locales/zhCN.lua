...
L['Colored by class'] = '按钮背景和边框根据职业染色'
...
L['|nRestyle other addons, including DBM, BigWigs, WeakAuras, Immersion, PremadeGroupsFilter, etc.'] = '|n美化其它插件，包括DBM BigWigs WeakAuras Immersion PremadeGroupsFilter等等。'
