...
ns.localization.unitframecolourSmoothTooltip = "玩家/目标/焦点的血量根据当前血量百分比染色。"
...
ns.localization.unitframecastbar_separatePlayerTooltip = "显示单独分离的玩家施法条"
ns.localization.unitframecastbar_separateTargetTooltip = "显示单独分离的目标施法条"
ns.localization.unitframeenableGroup = "启用小队/团队框体"
ns.localization.unitframeenableGroupTooltip = "禁用此项如果你想要使用其他小队/团队类插件。"
ns.localization.unitframegroupNames = "显示名字"
ns.localization.unitframegroupNamesTooltip = "在小队/团队框体上显示名字。"
ns.localization.unitframegroupColourSmooth = "平滑染色"
ns.localization.unitframegroupColourSmoothTooltip = "小队/团队的血量根据当前血量百分比染色。"
...
ns.localization.unitframebossColourSmoothTooltip = "首领的血量根据当前血量百分比染色。"
...
ns.localization.unitframegroupFilter = "显示队伍数量"
