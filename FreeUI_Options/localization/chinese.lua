...
ns.localization.actionbarlayoutStyle3 = "简洁布局 (隐藏动作条)"
...
ns.localization.chatwhisperSound = "密语提示"
ns.localization.chatwhisperSoundTooltip = "当收到密语时触发声音提示。"
ns.localization.chattimeStamp = "时间戳"
ns.localization.chattimeStampTooltip = "添加自定义的时间戳。"
ns.localization.chatitemLinkLevel = "装备链接增强"
ns.localization.chatitemLinkLevelTooltip = "为装备链接添加装等/位置/宝石等详细信息。"
ns.localization.chatspamageMeters = "伤害统计数据简化"
ns.localization.chatspamageMetersTooltip = "把伤害统计类插件输出的数据简化为一个可点击的链接。"
ns.localization.chatminimizeButton = "功能按钮"
ns.localization.chatminimizeButtonTooltip = "在聊天框左下角添加一个小按钮，左键点击隐藏整个聊天框，右键点击加入/离开世界频道。"
...
ns.localization.chatuseFilterTooltip = "自动过滤一些无用的信息。"
...
ns.localization.unitframetransMode = "透明模式"
ns.localization.unitframetransModeTooltip = "禁用该项如果你喜欢实色模式。"
ns.localization.unitframesmoothHealthUpdate = "平滑血条变色"
ns.localization.unitframesmoothHealthUpdateTooltip = "根据血量平滑变色，该项只在透明模式下生效。"
ns.localization.unitframegradient = "渐变磨砂"
ns.localization.unitframegradientTooltip = "添加一层渐变磨砂蒙版。"
...
ns.localization.unitframespellRange = "距离提示"
ns.localization.unitframespellRangeTooltip = "超出距离的小队/团队框体淡化。"
...
ns.localization.unitframeclassPowerTooltip = "显示职业资源条，比如盗贼的连击点圣骑的豆子。"
...
ns.localization.unitframecastbar = "启用施法条"
ns.localization.unitframecastbarTooltip = "禁用该项如果你想要使用其他的施法条类插件。"
ns.localization.unitframecbSeparate_player = "分离玩家施法条"
ns.localization.unitframecbSeparate_target = "分离目标施法条"
ns.localization.unitframeenableGroup = "启用小队/团队框体"
ns.localization.unitframeenableGroupTooltip = "禁用此项如果你想要使用其他小队/团队类插件。"
ns.localization.unitframepartyNameAlways = "显示名字"
ns.localization.unitframepartyNameAlwaysTooltip = "在小队/团队框体上显示名字，该项覆盖损失生命值。"
ns.localization.unitframepartyMissingHealth = "损失生命值"
ns.localization.unitframepartyMissingHealthTooltip = "在小队/团队框体上显示损失的生命值。"
