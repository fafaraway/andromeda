...
ns.localization.actionbarlayoutStyle3 = "极简模式 (默认隐藏动作条，进入战斗或者选择目标后显示)"
...
ns.localization.unitframecolourSmooth_RaidTooltip = "团队框体的血量条根据当前血量百分比染色。"
...
ns.localization.unitframecolourSmooth_BossTooltip = "首领框体的血量条根据当前血量百分比染色。"
