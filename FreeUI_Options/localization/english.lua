...
ns.localization.unitframescastbarExtended = "Player castbar as separate bar"
ns.localization.unitframescastbarExtendedTooltip = "When this option is disabled, the player cast bar is embedded in the player frame."
