...
ns.localization.generalrareAlertTooltip = "Show a raid warning and play a sound when a rare creature is spotted on the Timeless Isle. Check your minimap for the location."
...
ns.localization.automationautoAccept = "Accept invites from friends and guildies"
...
ns.localization.automationquestRewardHighlightTooltip = "Highlights the quest reward with the highest vendor sell price."
