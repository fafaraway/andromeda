...
ns.localization.general = {
	...
	sub_basic = '基础设定',
	already_known = '已知染色',
	already_known_tip = '在商人以及拍卖面板为已经学会的配方宠物坐骑添加一层绿色的染色方便分辨。',
	blizz_mover = '解锁游戏默认面板',
	blizz_mover_tip = '解锁游戏默认面板，使之可以自由拖动。',
	hide_boss_banner = '隐藏副本掉落通知横幅',
	hide_boss_banner_tip = '隐藏副本掉落通知横幅。',
	hide_talking_head = '隐藏情景对话框体',
	hide_talking_head_tip = '隐藏情景对话框体。',
	mail_button = '邮件收取增强',
	mail_button_tip = '一键收取所有邮件并显示邮件所含金额及物品。',
	trade_tabs = '生活技能快捷标签',
	trade_tabs_tip = '在专业面板右侧添加各类商业以及生活技能的快捷标签。',
	missing_stats = '属性补全',
	missing_stats_tip = '人物面板显示所有被隐藏的属性。',
	pet_filter = '宠物类型快捷标签',
	pet_filter_tip = '在宠物面板添加切换宠物类型的快捷标签。',
	trade_target_info = '交易保护',
	trade_target_info_tip = '在交易面板显示当前交易目标的信息避免受骗。',
	undress_button = '试衣间增强',
	undress_button_tip = '在试衣间面板添加脱衣按钮。',
	item_level = '显示物品等级',
	...
	tidy_errors = '错误信息简化',
	tidy_errors_tip = '错误信息简化。',
	account_keystone = '账号钥石信息',
	account_keystone_tip = '保存记录账号下所有角色的钥石信息。',
	queue_timer = '队列计时',
	...
	auto_reject_stranger = "屏蔽陌生人邀请",
	auto_reject_stranger_tip = "屏蔽来自陌生人的组队邀请。",
	instant_loot = "快速拾取",
	...
	sub_camera = '镜头视角',
	action_camera = '动作模式',
	action_camera_tip = '使用动作模式的镜头视角。',
	faster_camera = '快速调整镜头',
	faster_camera_tip = '加快镜头拉近拉远的调整速度。',
	sub_uiscale = '界面缩放',
	ui_scale = '全局缩放设定',
	ui_scale_tip = '全局界面缩放设定，建议1080P设为1，1440P设为1.4，2160P设为2。',
}
...
ns.localization.chat = {
	...
	sub_feature = '便利功能',
	abbreviate = '频道名简化',
	abbreviate_tip = '简化缩短频道名。',
	whisperAlert = '密语提醒',
	whisperAlert_tip = '收到密语时播放一个提示音，普通密语和战网密语的提示音不同。',
	itemLinks = '物品详情',
	itemLinks_tip = '聊天框的物品链接显示详细的图标装等部位宝石等信息。',
	spamageMeter = '伤害统计信息简化',
	...
	auto_toggle_chat_bubble_tip = '进入地下城开启聊天气泡，离开后关闭。',
	blockStranger = '陌生人密语过滤',
	blockStranger_tip = '过滤来自陌生人的密语。',
	allowFriendsSpam = '不过滤好友的发言',
	allowFriendsSpam_tip = '不过滤来自好友队友以及公会会员的发言。',
	sub_filter = '过滤',
	filters = '聊天信息过滤',
	filters_tip = '过滤重复性刷屏各种符号以及包含关键字的内容。',
	blockAddonSpam = '插件信息过滤',
...
ns.localization.audio = {
	...
	sub_basic = '基础设定',
	enable = '已知染色',
	enable_tip = '在商人以及拍卖面板为已经学会的配方宠物坐骑添加一层绿色的染色方便分辨。',
}
