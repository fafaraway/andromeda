...
C.CharacterSettings = {
    ...
    General = {
        ...
        MicroMenu = true,
        MicroMenuClassColor = true,
        MicroMenuBackdrop = true,
        MicroMenuBackdropAlpha = 0.35,
        MicroMenuButtonSize = 20,
        MicroMenuButtonOutAlpha = 0.4,
        MicroMenuButtonInAlpha = 1,
        MicroMenuSmooth = 0.5,
        MicroMenuButtonGap = 2,
        MicroMenuBarHeight = 22,
        GroupTool = true,
        RuneCheck = false,
        Countdown = '10',
    },
...
C.AccountSettings = {
    ...
    CustomClassColors = {
        HUNTER = { r = 0, g = 0.58, b = 0.19 },
        WARRIOR = { r = 0.6, g = 0.53, b = 0.46 },
        SHAMAN = { r = 0, g = 0.38, b = 0.4 },
