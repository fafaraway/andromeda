...
function GUI:CreateCreditsFrame(parent)
    ...
    F.CreateFS(credit, C.Assets.Font.Bold, 16, nil, datas[1], {1, .5, 0}, true, 'TOP', 0, -50)
    F.CreateFS(credit, C.Assets.Font.Regular, 14, nil, datas[2], {.6, .2, .9}, true, 'TOP', 0, -90)
    F.CreateFS(credit, C.Assets.Font.Condensed, 12, nil, datas[3], {0, .4, .9}, true, 'TOP', 0, -220)
end
