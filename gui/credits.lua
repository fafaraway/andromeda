...
function GUI:CreateCreditsFrame(parent)
    ...
    F.CreateFS(credit, C.Assets.Fonts.Header, 22, nil, datas[1], 'BLUE', true, 'TOP', 0, -50)
    F.CreateFS(credit, C.Assets.Fonts.Condensed, 16, nil, datas[2], 'GREEN', true, 'TOP', 0, -90)
    F.CreateFS(credit, C.Assets.Fonts.Regular, 12, nil, datas[3], 'GREY', true, 'TOP', 0, -220)
end
