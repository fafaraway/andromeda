...
GUI.OptionsList = {
    [1] = { -- general
        ...
        },
        {
            ...
            L['Number Format'],
            true,
            { L['Standard: b/m/k'], L['Asian: y/w'], L['Full digitals'] },
        },
        {
            1,
            'General',
        ...
        { 1, 'General', 'GroupTool', L['Group Tool'], true, nil, nil, L['Add group tool at the top of the screen.'] },
        {},
    ...
    [4] = { -- chat
        ...
        { 1, 'Chat', 'GuildOnly', L['Guild Members Only'] },
        {
            2,
            'Chat',
            'InviteKeyword',
    ...
    [6] = { -- combat
        ...
        { 3, 'ACCOUNT', 'WorldTextScale', L['Combat Text Scale'], true, { 1, 3, 0.1 }, UpdateWorldTextScale },
        {
            1,
            'ACCOUNT',
        ...
        { 4, 'Combat', 'EasyFocusKey', L['Easy Focus'], nil, { 'CTRL', 'ALT', 'SHIFT', _G.DISABLE }, nil, L['Use the left mouse button to click on any unit while holding down the specified modifier key to quickly set it as focus.'] },
        { 4, 'Combat', 'EasyMarkKey', L['Easy Mark'], true, { 'CTRL', 'ALT', 'SHIFT', _G.DISABLE }, nil, L['Use the left mouse button to click on any unit while holding down the specified modifier key to quickly mark it.'] },
    },
    [7] = { -- announcement
        ...
        { 1, 'Announcement', 'Spells', L['Major spells'], nil, SetupAnnounceableSpells },
        {
            ...
            _G.CHANNEL,
            true,
            { _G.CHAT_MSG_PARTY .. '/' .. _G.CHAT_MSG_RAID, _G.YELL, _G.EMOTE, _G.SAY },
        },
    ...
    [11] = { -- unitframe
        ...
        { 4, 'Unitframe', 'TextureStyle', L['Texture Style'], nil, {} },
        {
            ...
            L['Health Color'],
            true,
            { L['Default White'], L['Class Color'], L['Percentage Gradient'] },
            UpdateHealthColor,
        },
        {
            1,
        ...
        { 1, 'Unitframe', 'StealableBuffs', L['Display Dispellable Buffs'], true },
        {},
        {
            1,
            'Unitframe',
    ...
    [13] = { -- nameplate
        ...
        },
        {
            ...
            L['Aura Filter Mode'],
            true,
            { L['BlackNWhite'], L['PlayerOnly'], L['IncludeCrowdControl'] },
        },
    ...
    [14] = { -- theme
        {
            ...
            nil,
            nil,
            L['Add shadow border to interface widgets.'],
        },
        {
            1,
            'ACCOUNT',
        ...
        },
        {
            ...
            nil,
            nil,
            L['Enable animation effect when mouse hover over button.'],
        },
        {
            1,
            'ACCOUNT',
            ...
            nil,
            nil,
            L['Color interface widgets highlight effect by class.'],
        },
        {
            1,
            'ACCOUNT',
        ...
        },
        {
            ...
            nil,
            nil,
            L['Restyle some necessary third-party AddOns, such as DBM, BigWigs, WeakAuras, Immersion, PremadeGroupsFilter, etc.'],
        },
        { 5, 'ACCOUNT', 'BackdropColor', L['Frame Backdrop Color'] },
        { 5, 'ACCOUNT', 'BorderColor', L['Frame Border Color'], 2 },
        { 5, 'ACCOUNT', 'ButtonBackdropColor', L['Widget Backdrop Color'] },
        { 5, 'ACCOUNT', 'WidgetHighlightColor', L['Widget Highlight Color'], 2 },
        { 3, 'ACCOUNT', 'BackdropAlpha', L['Frame Backdrop Alpha'], nil, { 0, 1, 0.01 }, UpdateBackdropAlpha },
        { 3, 'ACCOUNT', 'ButtonBackdropAlpha', L['Widget Backdrop Alpha'], true, { 0, 1, 0.01 } },
    },
    [15] = {},
    [16] = {},
    [17] = {},
