...
GUI.OptionsList = {
    ...
    [14] = {
        ...
        {1, 'Nameplate', 'InterruptIndicator', L.GUI.NAMEPLATE.INTERRUPT_INDICATOR, true},
        {1, 'Nameplate', 'ExplosiveIndicator', L.GUI.NAMEPLATE.EXPLOSIVE_INDICATOR, nil, setupNPExplosiveScale, nil, L.GUI.NAMEPLATE.EXPLOSIVE_INDICATOR_TIP},
        {1, 'Nameplate', 'SpitefulIndicator', L.GUI.NAMEPLATE.SPITEFUL_INDICATOR, true, nil, nil, L.GUI.NAMEPLATE.SPITEFUL_INDICATOR_TIP},
        {1, 'Nameplate', 'MajorSpellsGlow', L.GUI.NAMEPLATE.MAJOR_SPELLS_GLOW, nil, setupMajorSpellsGlow, nil, L.GUI.NAMEPLATE.MAJOR_SPELLS_GLOW_TIP},
        {1, 'Nameplate', 'SpellTarget', L.GUI.NAMEPLATE.SPELL_TARGET, true, nil, nil, L.GUI.NAMEPLATE.SPELL_TARGET_TIP},
