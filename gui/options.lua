...
GUI.OptionsList = {
    ...
    [13] = { -- nameplate
        ...
        {1, 'Nameplate', 'FriendlyPlate', L['Friendly Nameplate Size'], true, SetupNameplateFriendlySize, RefreshAllPlates, L["Set size separately for friendly units' nameplate.|nIf disabled, friendly units' nameplate will use the same size setting as the hostile units' nameplate."]},
        {1, 'Nameplate', 'FriendlyClickThrough', L['Friendly Click Through'], nil, nil, UpdatePlateClickThrough, L["Friendly units' nameplate ignore mouse clicks."]},
        {1, 'Nameplate', 'EnemyClickThrough', L['Enemy Click Through'], true, nil, UpdatePlateClickThrough, L["Hostile units' nameplate ignore mouse clicks."]},
        {},
