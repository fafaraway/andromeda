...
GUI.OptionsList = {
    [1] = { -- general
        ...
        {1, 'General', 'EnhancedPremade', L['Enhanced Premade'], true, nil, nil, L['Enhance the premade, including quick apply by double click, hide group join notice, styled group roles, auto invite applicants, show leader overall score, abbr keystone name for Tazavesh.']},
    ...
    [13] = { -- nameplate
        ...
        {1, 'Nameplate', 'DesaturateIcon', L['Desaturate Debuffs'], true, nil, RefreshAllPlates, L['Desaturate debuffs cast by others.']},
        {1, 'Nameplate', 'DebuffTypeColor', L['Debuffs Type Color'], nil, nil, RefreshAllPlates, L['Coloring debuffs border by type.|nMagic is blue, Curse is purple, Poison is green, Disease is yellow, and others are red.']},
        {1, 'Nameplate', 'DisableMouse', L['Disable Mouse'], true, nil, RefreshAllPlates, L['Disable tooltip on auras.']},
        {1, 'Nameplate', 'StealableBuffs', L['Purgeable Buffs'], nil, nil, RefreshAllPlates, L['Display purgeable buffs.']},
