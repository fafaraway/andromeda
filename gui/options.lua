...
GUI.OptionsList = {
    [1] = { -- general
        ...
        {},
        {
            ...
            nil,
            nil,
            L['Add micro menu bar at the bottom of the screen.'],
        },
        ...
        },
        {
            ...
            nil,
            nil,
            L['Right-click the quest or achievement in the objective tracker to get the corresponding Wowhead link.'],
        },
        {
            1,
            'Quest',
    ...
    [4] = { -- chat
        ...
        },
        {
            ...
            nil,
            nil,
            L["If enanbled, repeat messages spammer will be blocked, you won't receive any messages from it any more."],
        },
        {
            1,
            'Chat',
    ...
    [5] = { -- actionbar
        ...
        },
        {
            ...
            nil,
            UpdateEquipColor,
            L['Dyeing the button border of equipped items.'],
        },
        {
            1,
            'Actionbar',
            ...
            nil,
            nil,
            L['Dyeing the buttons backdrop of actionbar.'],
        },
        {
            1,
            'Actionbar',
    ...
    [6] = { -- combat
        ...
        },
        {
            ...
            L['Simple floating combat text'],
            nil,
            SetupSimpleFloatingCombatText,
            nil,
            L['Provides necessary combat infomation, including damage healing and events (dodge, parry, absorb etc...).'],
        },
    ...
    [13] = { -- nameplate
        ...
        { 4, 'Nameplate', 'TextureStyle', L['Texture Style'], true, {} },
        {
            ...
            nil,
            nil,
            L['Friendly nameplate only display the enlarged name and hide the health bar.'],
        },
        ...
        },
        {
            ...
            L["Friendly units' nameplate ignore mouse clicks."],
        },
        {
            1,
            'Nameplate',
    ...
    [14] = { -- theme
        {
            ...
            nil,
            nil,
            L['Add shadow border to most of UI widgets.'],
        },
        {
            1,
            'ACCOUNT',
        ...
        { 3, 'ACCOUNT', 'BackdropAlpha', L['Backdrop Alpha'], nil, { 0, 1, 0.01 }, UpdateBackdropAlpha },
        { 3, 'ACCOUNT', 'ButtonBackdropAlpha', L['Button Backdrop Alpha'], true, { 0, 1, 0.01 } },
    },
    [15] = {},
    [16] = {},
    [17] = {},
