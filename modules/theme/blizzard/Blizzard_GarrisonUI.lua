...
C.Themes['Blizzard_GarrisonUI'] = function()
    ...
    hooksecurefunc(
        ...
        function(portraitFrame, followerInfo)
    ...
    hooksecurefunc(
        _G.GarrisonMission,
        'SetEnemies',
        function(_, missionPage, enemies)
            for i = 1, #enemies do
    ...
    hooksecurefunc(
        _G.GarrisonMission,
        'MissionCompleteInitialize',
        function(self, missionList, index)
    ...
    OrderHallMissionFrame:HookScript(
        'OnShow',
        function()
    ...
    F.CreateBDFrame(_G.CombatLog.CombatLogMessageFrame, .25)
        ...
        function _G.VPEX_OnUIObjectCreated(otype, widget, peek)
            if widget:IsObjectType('Frame') then
                ...
                elseif otype == 'IconButton' then
                    ...
                    widget:SetPushedTexture(C.Assets.button_pushed)
