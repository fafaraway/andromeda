...
C.Themes['Blizzard_ArchaeologyUI'] = function()
    ...
    _G.ArchaeologyFrameRankBarBar:SetTexture(C.Assets.bd_tex)
    ...
    barTexture:SetTexture(C.Assets.bd_tex)
    ...
    _G.ArcheologyDigsiteProgressBar.FillBar:SetStatusBarTexture(C.Assets.bd_tex)
