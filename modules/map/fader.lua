...
local function EnterCombat()
    F:UIFrameFadeOut(_G.Minimap.holder, .1, _G.Minimap.holder:GetAlpha(), 0)
    F:UIFrameFadeOut(_G.Minimap, .1, _G.Minimap:GetAlpha(), 0)
end

local function LeaveCombat()
    F:UIFrameFadeIn(_G.Minimap.holder, .1, _G.Minimap.holder:GetAlpha(), 1)
    F:UIFrameFadeIn(_G.Minimap, .1, _G.Minimap:GetAlpha(), 1)
end
