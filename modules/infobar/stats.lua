...
function INFOBAR:Stats()
	...
	FreeUIStatsButton:HookScript(
		...
		function(self)
			...
			GameTooltip:AddDoubleLine(' ', C.Assets.mouse_left .. L['Toggle Addons Panel'] .. ' ', 1, 1, 1, .9, .82, .62)
			GameTooltip:AddDoubleLine(' ', C.Assets.mouse_right .. L['Toggle Timer Panel'] .. ' ', 1, 1, 1, .9, .82, .62)
			GameTooltip:Show()
		end
	)
