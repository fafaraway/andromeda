...
local Dropdown = F.Libs.LibDropDown:NewMenu(Talentless)
...
function Talentless:CreateSpecButtons()
    ...
    local OnEnter = function(self)
        ...
        _G.GameTooltip:AddLine(string.format('|cff33ff33%s|r - %s', _G.HELPFRAME_REPORT_PLAYER_RIGHT_CLICK, _G.EQUIPMENT_MANAGER))
        _G.GameTooltip:Show()
    end
...
function Talentless:ADDON_LOADED(addon)
    if (addon == 'Blizzard_TalentUI') then
        ...
        _G.PlayerTalentFrameTalentsTutorialButton.Show = function()
        end
