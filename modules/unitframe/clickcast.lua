...
header:SetPoint('TOP')
header.text = F.CreateFS(header, C.Assets.Fonts.Regular, 14, true, L['Configure Spell Binding'], 'YELLOW', nil, 'TOP', 0, -10)
...
function UNITFRAME:ClickCast()
    ...
    SpellBinder.OpenButton:SetScript(
        'OnShow',
        function(self)
            if SpellBinder:IsVisible() then
            ...
            self:SetScript(
                ...
                function()
                    ...
                    _G.GameTooltip:AddLine(
                        L[
                            "|nCtrl/Alt/Shift + any mouse button to binds spells.|nCast spells on party or raid frames with binded click set.|nPay attention to avoid key conflict if you enabled 'Easy Focus' feature."
                        ],
                        .6,
                        .8,
                        1,
