...
tinsert(C.BlizzThemes, function()
	...
	local function updateBarTexture(self, atlas)
		if atlasColors[atlas] then
			self:SetStatusBarTexture(C.Assets.Textures.statusbar)
	...
	hooksecurefunc(_G.UIWidgetTemplateCaptureBarMixin, "Setup", function(self)
		...
		self.LeftBar:SetTexture(C.Assets.Textures.statusbar)
		self.NeutralBar:SetTexture(C.Assets.Textures.statusbar)
		self.RightBar:SetTexture(C.Assets.Textures.statusbar)
