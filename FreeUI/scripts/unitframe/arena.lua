...
if not C.unitframe.enableArena then return end
...
for i = 1, 5 do
	...
	arenaFrames[i].Health:SetStatusBarTexture(C.media.sbTex)
	arenaFrames[i].SpecClass = F.CreateFS(arenaFrames[i].Health, C.font.pixel, 8, 'OUTLINEMONOCHROME')
