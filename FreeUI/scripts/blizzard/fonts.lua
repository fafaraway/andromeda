...
function module:FontStyle()
	...
	local function updateAchievement(event, addon)
		if addon == "Blizzard_AchievementUI" then
			...
			F:UnregisterEvent(event, updateAchievement)
		end
	end
...
SetFont("FriendsFont_Normal",    CHAT, 14, nil, nil, {0, 0, 0}, 1, -1)
SetFont("FriendsFont_Small",     CHAT, 12, nil, nil, {0, 0, 0}, 1, -1)
SetFont("FriendsFont_Large",     CHAT, 14, nil, nil, {0, 0, 0}, 1, -1)
SetFont("FriendsFont_UserText",  CHAT, 12, nil, nil, {0, 0, 0}, 1, -1)
