...
function BLIZZARD:Fonts()
	...
	SetFont("SystemFont_Shadow_Huge1",         C.font.normal, 20, nil, nil, {0, 0, 0}, 2, -2)
	SetFont("SystemFont_Huge2",                C.font.header, 24)
	SetFont("SystemFont_Shadow_Huge2",         C.font.header, 24, "OUTLINE", nil, {0, 0, 0}, 1, -1)
	SetFont("SystemFont_Shadow_Huge3",         C.font.header, 25, nil, nil, {0, 0, 0}, 1, -1)
	SetFont("SystemFont_Shadow_Outline_Huge3", C.font.header, 25, "OUTLINE", nil, {0, 0, 0}, 1, -1)
	SetFont("SystemFont_World",                C.font.header, 64, nil, nil, {0, 0, 0}, 1, -1)
	SetFont("SystemFont_World_ThickOutline",   C.font.header, 64, "THICKOUTLINE", nil, {0, 0, 0}, 1, -1)
	SetFont("SystemFont_Shadow_Outline_Huge2", C.font.normal, 22, "OUTLINE", nil, {0, 0, 0}, 2, -2)
	SetFont("SystemFont_Med1",                 C.font.normal, 12)
	SetFont("SystemFont_WTF2",                 C.font.header, 36)
	SetFont("SystemFont_Outline_WTF2",         C.font.header, 36, "OUTLINE")
	SetFont("GameTooltipHeader",               C.font.normal, 14, "OUTLINE", nil, {0, 0, 0}, 1, -1)
	...
	SetFont("NumberFont_GameNormal",              C.font.normal, 10, "OUTLINE", nil, {0, 0, 0}, 1, -1)
	...
	SetFont("NumberFont_Outline_Huge",            C.font.damage, 30, "OUTLINE", nil, {0, 0, 0}, 1, -1)
