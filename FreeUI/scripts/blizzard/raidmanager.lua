...
local function textbutton(button,parent,size,a1,a2,x,y,fsize,text,l)
...
local function buttons()
	...
	textbutton('readycheck',pull,30,'TOP','BOTTOM',1,-2,24,'x',READY_CHECK)
	...
	if marker then
		...
		marker:HookScript('OnLeave', function() mark.text:SetVertexColor(1, 1, 1, .3) end)
