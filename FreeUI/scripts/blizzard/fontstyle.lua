...
function module:FontStyle()
	...
	SetFont("SystemFont_Large",                C.font.normal, 16, nil, nil)
	...
	SetFont("SystemFont_Med1",                 C.font.normal, 12, nil, nil)
	...
	SetFont("NumberFont_GameNormal",              C.font.chat, 12, 'OUTLINE', nil, {0, 0, 0}, 1, -1)
	SetFont("NumberFont_OutlineThick_Mono_Small", C.font.chat, 12, 'OUTLINE', nil, {0, 0, 0}, 1, -1)
	SetFont("NumberFont_Small",                   C.font.chat, 12, 'OUTLINE', nil, {0, 0, 0}, 1, -1)
	SetFont("NumberFont_Normal_Med",              C.font.chat, 12, 'OUTLINE', nil, {0, 0, 0}, 1, -1)
	SetFont("NumberFont_Outline_Med",             C.font.chat, 12, 'OUTLINE', nil, {0, 0, 0}, 1, -1)
	SetFont("NumberFont_Outline_Large",           C.font.chat, 14, 'OUTLINE', nil, {0, 0, 0}, 1, -1)
	SetFont("NumberFont_Outline_Huge",            C.font.header, 30, 'OUTLINE', nil, {0, 0, 0}, 1, -1)
	...
	SetFont("Game11Font", C.font.normal, 11, nil, nil)
	SetFont("Game12Font", C.font.normal, 12, nil, nil)
	SetFont("Game13Font", C.font.normal, 13, nil, nil)
	SetFont("Game13FontShadow", C.font.normal, 13, nil, nil, {0, 0, 0}, 1, -1)
	SetFont("Game15Font", C.font.normal, 15, nil, nil)
	SetFont("Game16Font", C.font.normal, 16, nil, nil)
	SetFont("Game18Font", C.font.normal, 18, nil, nil)
	SetFont("Game20Font", C.font.normal, 20, nil, nil)
	SetFont("Game24Font", C.font.normal, 24, nil, nil)
	SetFont("Game27Font", C.font.normal, 27, nil, nil)
	SetFont("Game30Font", C.font.normal, 30, nil, nil)
	SetFont("Game32Font", C.font.normal, 32, nil, nil)
	SetFont("Game36Font", C.font.normal, 36, nil, nil)
	SetFont("Game46Font", C.font.normal, 46, nil, nil)
	SetFont("Game48Font", C.font.normal, 48, nil, nil)
	SetFont("Game48FontShadow", C.font.normal, 48, nil, nil, {0, 0, 0}, 1, -1)
	SetFont("Game60Font", C.font.normal, 60, nil, nil)
	SetFont("Game72Font", C.font.normal, 72, nil, nil)
	SetFont("Game120Font", C.font.normal, 120, nil, nil)
