...
function module:FontStyle()
	...
	SetFont("GameTooltipHeader",        C.font.normal, 14)
	...
	SetFont("QuestFont_Super_Huge",         C.font.header, 24, nil, {.8, .8, .2})
	SetFont("QuestFont_Super_Huge_Outline", C.font.header, 24, "OUTLINE", {.8, .8, .2})
