...
if not C.general.screenSaver then return end

-- rScreenSaver by zorker
-- Show some cool stuff while you AFKed
...
-- close button
local button = CreateFrame("Button", "screensaverclosebutton", f.model, "UIPanelButtonTemplate")
