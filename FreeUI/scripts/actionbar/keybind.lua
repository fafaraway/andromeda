...
if not C.actionbar.hoverBind then return end

-- Author: Nightcracker
-- Maintainer: Coote
-- Notes: Allows you to bind keys on buttons by hovering over them.

local bind, localmacros, frame = CreateFrame('Frame', 'FreeUIHoverBind', UIParent), 0
-- SLASH COMMAND
SlashCmdList.MOUSEOVERBIND = function()
	...
	if not bind.loaded then
		...
		function bind:CallBindFrame()
			...
			button1:SetNormalFontObject('GameFontNormalSmall')
