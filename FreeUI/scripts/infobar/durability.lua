...
function module:Durability()
	...
	local FreeUIDurabilityButton = module.FreeUIDurabilityButton

	FreeUIDurabilityButton = module:addButton('', module.POSITION_RIGHT, 120, function(self, button)
