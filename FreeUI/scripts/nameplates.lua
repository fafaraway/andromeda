...
local UpdateFrame = function(self)
	...
	self.level:SetFont(C.media.font, C.FONT_SIZE_NORMAL * offset, "OUTLINEMONOCHROME")
...
local StyleFrame = function(frame)
	...
	local newNameRegion = F.CreateFS(frame, C.FONT_SIZE_NORMAL * offset, "CENTER")
	...
	castText:SetFont(C.media.font, C.FONT_SIZE_NORMAL * offset, "OUTLINEMONOCHROME")
