...
function INFOBAR:Stats()
	...
	FreeUIStatsButton:HookScript('OnEnter', function(self)
		...
		GameTooltip:AddDoubleLine(' ', C.Assets.Textures.btnleft..L['INFOBAR_OPEN_ADDON_PANEL']..' ', 1,1,1, .9, .82, .62)
		GameTooltip:AddDoubleLine(' ', C.Assets.Textures.btnright..L['INFOBAR_OPEN_TIMER_TRACKER']..' ', 1,1,1, .9, .82, .62)
		GameTooltip:Show()
	end)
