...
local GameIcons = {
	...
	[BNET_CLIENT_WOW .. 'C'] = {
		...
		Modern = mediaPath .. 'game_icons\\WoW'
	},
	...
	[BNET_CLIENT_COD_BOCW] = {
		...
		Modern = mediaPath .. 'game_icons\\COD_CW'
	},
	[BNET_CLIENT_COD_MW] = {
		Default = BNet_GetClientTexture(BNET_CLIENT_COD_MW),
		Modern = mediaPath .. 'game_icons\\COD_MW'
	},
	[BNET_CLIENT_COD_MW2] = {
		Default = BNet_GetClientTexture(BNET_CLIENT_COD_MW2),
		Modern = mediaPath .. 'game_icons\\COD_MW2'
	},
...
local function UpdateFriendButton(button)
	...
	if game and game ~= '' then
		...
		local iconTex = GameIcons[iconGroup]['Modern']
