...
if C.isDeveloper then
	...
	C.Assets.Fonts.Chat   = 'Fonts\\FreeUI\\bold.ttf'
...
loader:SetScript('OnEvent', function(self, _, addon)
	...
	SetFont(_G.GameTooltipHeader, NORMAL, 16)
	...
	SetFont(_G.ErrorFont, NORMAL, 14, nil, 'THICK')
	SetFont(_G.CombatTextFont, COMBAT, 200, 'THINOUTLINE')

	SetFont(_G.RaidWarningFrame.slot1, NORMAL, 20, nil, 'THICK')
	SetFont(_G.RaidWarningFrame.slot2, NORMAL, 20, nil, 'THICK')
	SetFont(_G.RaidBossEmoteFrame.slot1, NORMAL, 20, nil, 'THICK')
	SetFont(_G.RaidBossEmoteFrame.slot2, NORMAL, 20, nil, 'THICK')
