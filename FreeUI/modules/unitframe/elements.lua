...
function UNITFRAME:AddHealthBar(self)
	...
	health:SetStatusBarTexture(C.Assets.grad_tex)
	...
	if cfg.transparency then
		...
		deficit:SetStatusBarTexture(C.Assets.grad_tex)
...
function UNITFRAME:AddHealthPrediction(self)
	if cfg.heal_prediction then 
		...
		myBar:SetStatusBarTexture(C.Assets.Textures.statusbar)
		...
		otherBar:SetStatusBarTexture(C.Assets.Textures.statusbar)
