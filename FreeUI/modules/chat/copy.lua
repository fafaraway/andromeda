...
function CHAT:ChatCopy_Create()
	...
	copy:SetScript('OnEnter', function(self)
		...
		GameTooltip:AddDoubleLine(' ', C.Assets.Textures.btnleft..L['CHAT_TOGGLE_FRAME']..' ', 1,1,1, .9, .8, .6)
		GameTooltip:AddDoubleLine(' ', C.Assets.Textures.btnright..L['CHAT_TOGGLE_WC']..' ', 1,1,1, .9, .8, .6)
		GameTooltip:AddDoubleLine(' ', C.Assets.Textures.btnmid..L['CHAT_COPY']..' ', 1,1,1, .9, .8, .6)
		GameTooltip:Show()
	end)
