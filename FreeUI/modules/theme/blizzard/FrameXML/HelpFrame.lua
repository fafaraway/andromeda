...
tinsert(C.BlizzThemes, function()
	...
	local function styleTab(bu)
		...
		bu.text:SetFont(C.Assets.Fonts.Regular, 14, "OUTLINE")
		F.Reskin(bu, true)
	...
	HelpFrameAccountSecurityOpenTicket.text:SetFont(C.Assets.Fonts.Regular, 14, "OUTLINE")
	HelpFrameOpenTicketHelpOpenTicket.text:SetFont(C.Assets.Fonts.Regular, 14, "OUTLINE")
