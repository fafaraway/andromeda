...
local function LoadPrepatchHelpFrame()
	...
	local function styleTab(bu)
		...
		bu.text:SetFont(C.Assets.Fonts.Regular, 14)
		F.Reskin(bu, true)
	...
	HelpFrameAccountSecurityOpenTicket.text:SetFont(C.Assets.Fonts.Regular, 14)
	HelpFrameOpenTicketHelpOpenTicket.text:SetFont(C.Assets.Fonts.Regular, 14)
